...
import { ExternalLinkIcon, CodeIcon, UsersIcon, SmartphoneIcon, ServerIcon } from 'lucide-react';
export const Projects = () => {
  ...
  return <section id="projects" className="py-20 w-full bg-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div className="space-y-8">
          {projects.map((project, index) => <div key={index} className="bg-gray-800/50 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden transition-transform hover:scale-[1.01] duration-300">
              ...
              <div className="p-6 sm:p-8">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="px-3 py-1 text-xs font-medium bg-blue-900/40 text-blue-300 rounded-full">
                    {project.type}
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  {project.teamProject && <div className="flex items-start space-x-3">
                      <UsersIcon size={20} className="text-gray-400 mt-1 flex-shrink-0" />
                      <div>
                  ...
                  <div className="border-t border-gray-700 pt-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map(tech => <span key={tech} className="px-3 py-1 bg-gray-700 text-gray-200 text-sm rounded-md">
                          {tech}
                        </span>)}
                    </div>
                  </div>
                ...
                <div className="mt-6">
                  <a href="#" className="inline-flex items-center text-blue-400 font-medium hover:text-blue-300 transition-colors">
